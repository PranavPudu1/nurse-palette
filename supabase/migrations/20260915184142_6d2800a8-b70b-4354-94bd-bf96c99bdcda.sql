...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.day_off_requests TO authenticated;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.schedule_generations TO authenticated;
GRANT ALL ON public.schedule_generations TO service_role;
