...
| Round comparisons rotate cases and vary the child's message | The theme rounds | Every round reused case 1's exact question; rounds now anchor on a different case each round and never repeat a message. Round 1 leans gently toward the rubric's weakest criteria, one of round 2's close calls must target one, and the scored round 3 ignores the rubric so it stays an unbiased sample | Winnie think-aloud (Sep 22) |
